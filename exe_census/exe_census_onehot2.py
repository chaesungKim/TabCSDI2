...
from dataset_census_onehot2 import get_dataloader
...
foldername = "./save/census_onehot_fold" + str(args.nfold) + "/" + args.mecha + str(args.testmissingratio) + "_" + current_time + "/"
