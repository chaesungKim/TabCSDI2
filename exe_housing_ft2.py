...
from dataset_housing_ft2 import get_dataloader

parser = argparse.ArgumentParser(description="TabCSDI")
parser.add_argument("--config", type=str, default="housing_ft.yaml") ## yaml 만들기
...
foldername = "./save/housing_ft_fold" + str(args.nfold) + "/" + args.mecha + str(args.testmissingratio) + "_" + current_time + "/"
