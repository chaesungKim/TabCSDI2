...
class CSDI_base(nn.Module):
    ...
    ### MCAR 가정 시 원래와 같게 나오는지. 돌릴때마다 다르게 나오도록. (seed x)
    ...
    def evaluate_all(self, batch, n_samples): ### for using full_dataloader
        ...
        return samples, real_data, observed_data, target_mask, observed_mask, observed_tp ### real_data 추가
    ###
