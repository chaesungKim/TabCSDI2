...
from dataset_insurance_ft2 import get_dataloader

parser = argparse.ArgumentParser(description="TabCSDI")
parser.add_argument("--config", type=str, default="insurance_ft.yaml") ## yaml 만들기
...
foldername = "./save/insurance_ft_fold" + str(args.nfold) + "/" + args.mecha + str(args.testmissingratio) + "_" + current_time + "/"
